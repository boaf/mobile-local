...
(function(e, t, i) {
  ...
  (function(e) {
    ...
    e.fn[s] = function(e) {
      ...
      }, t.attachEvent && !t.addEventListener && !c &&
      function() {
        var t, n;
        l.start = function() {
    ...
    }), h.bind("scrollstop", k), e.mobile._maybeDegradeTransition = e.mobile._maybeDegradeTransition ||
    function(e) {
      return e
    ...
    e.widget("mobile.slider", e.mobile.widget, e.extend({
      ...
      _create: function() {
        var a, o, s = this,
          ...
          T = i.createElement("div"),
          D = e(T),
          P = this.options.highlight && !this.isToggleSwitch ?
        function() {
